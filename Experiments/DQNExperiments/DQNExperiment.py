...
def control_experiment(cfg):
    ...
    for kp, kd, ki, alpha, beta, optimizer, \
        ...
        minimum_eps, epsilon_decay_step, train_step, target_update_interval, d_tau, \
        inner_size, adapt_gains, epsilon, meta_lr in \
        zip(cfg['kp'], cfg['kd'], cfg['ki'], cfg['alpha'], cfg['beta'], cfg['optimizer'], \
            ...
            cfg['minimum_eps'], cfg['epsilon_decay_step'], cfg['train_step'], cfg['target_update_interval'], \
            cfg['d_tau'], cfg['inner_size'], cfg['adapt_gains'], cfg['epsilon'], cfg['meta_lr']):
        agent = build_PID_DQN(
            kp, ki, kd, alpha, beta, 
            cfg['env'], cfg['gamma'], optimizer,
            replay_memory_size, batch_size, learning_rate,
            tau, initial_eps, exploration_fraction,
            minimum_eps, epsilon_decay_step, train_step, target_update_interval,
            d_tau, inner_size, cfg['slow_motion'],
