...
def build_adaptive_agent(agent_name, env_name, env, policy, meta_lr, lambd, delay, get_optimal, gamma, kp, kd, ki, alpha, beta, epsilon, order=None, seed=42, meta_lr_p=None, meta_lr_d=None, meta_lr_I=None):
    ...
    #     return build_semi_gradient_Q_updater(*params, double=True)
        ...
        if agent_name.startswith("linear TD polynomial"):
            ...
            return build_linear_TD(env, policy, kp, ki, kd, alpha, beta, learning_rates, gamma, basis, is_q, adapt_gains=True, meta_lr=meta_lr, epsilon=epsilon, seed=seed)
...
def build_diagonal_semi_gradient_Q_updater(env, policy, meta_lr, lambd, learning_rates, gamma, delay, kp, kd, ki, alpha, beta, epsilon, meta_lr_p=None, meta_lr_d=None, meta_lr_I=None):
